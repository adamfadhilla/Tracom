...
<body>
  ...
  <script>
    ...
    function increaseQuantity(index) {
      ...
      const btn = document.querySelector(`.btn-increase[data-index="${index}"]`);
    ...
    function decreaseQuantity(index) {
      ...
      // Add animation feedback
      const btn = document.querySelector(`.btn-decrease[data-index="${index}"]`);
      btn.classList.add('animate');
      setTimeout(() => {
        btn.classList.remove('animate');
      }, 300);
    ...
    function attachQuantityButtons() {
      document.querySelectorAll('.btn-increase').forEach(btn => {
        btn.onclick = (e) => {
          e.preventDefault();
          increaseQuantity(btn.dataset.index);
        };
      });
      ...
      document.querySelectorAll('.btn-decrease').forEach(btn => {
        btn.onclick = (e) => {
          e.preventDefault();
          decreaseQuantity(btn.dataset.index);
        };
      });
    }
